...
#### 项目地址
>  codelei.cn 欢迎来访, 第一个开源作品大家多多支持。
#### 项目上手注意事项
- 项目网络请求封装在`network`文件夹，如果你需要使用的话请把`xxxxxx`修改为你的后台开启地址，不然你的项目是访问不了的，我在对应的文件中都有标注，封装在一个文件中这样管理起来也比较方便，后续更换框架也能给予更方面的更换，我的后台是`nodejs`写的，需要的朋友可以来找我要。`24h`在线。
